                            ...
                            <div class="container uploadfilebox ">
                                <div class="row rowubf2">
                                    ...
                                    {{--<form action="{{ url('upload-file') }}" enctype="multipart/form-data" method="POST">--}}
                                     ...
                                     <i class="fa fa-upload" aria-hidden="true"></i>  Choose image...<input type="file" name="image" hidden>
                                              </label>
                                  </span>
                                     ...
                                     <i class="fa fa-upload" aria-hidden="true"></i>  Choose file...<input type="file" name="text_file" hidden>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group inptxt form-group descinpt">
                                            ...
                                            <div class="col-md-12">
                                                {{Form::submit('Submit', ['class'=>'btn btnupld btnupldfiles btn-outline-success'])}}
                                    {{--            btn btn-lg align-middle  btnupld btn-outline-success my-2 my-sm-0 mx-auto align-self-center--}}
