                    ...
                    <div class="row">
                        ...
                        <div class="container uploadfilebox">
                            <div class="row rowubf2">
                                {!! Form::open(['action'=>['UploadController@update',$upload->id], 'method'=>'POST','files' => true]) !!}
                                {{--<form action="{{ url('upload-file') }}" enctype="multipart/form-data" method="POST">--}}
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-sm-10">
                                        <div class="input-group inptit form-group">
                                            {{Form::text('title',$upload->name,['class'=>'form-control','placeholder'=>'Enter document title...'])}}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group inptxt form-group">
                                            {{Form::textarea('description',$upload->description,['class'=>'form-control col-sm-9'])}}
